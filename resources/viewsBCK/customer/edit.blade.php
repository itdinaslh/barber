<form action="{{ url('/customer/editpost') }}" method="post">
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="Nama" value="{{ $cust->Nama }}" required autofocus/>
        </div>
        <div class="form-group">
            <label for="IdNum">No Identitas</label>
            <input type="text" class="form-control" name="IdNum" value="{{ $cust->IdNum }}"  />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="Occupation" value="{{ $cust->Occupation }}" />
        </div>
        <div class="form-group">
            <label for="City">Kota</label>
            <input type="text" class="form-control" name="City" value="{{ $cust->City }}" />
        </div>
        <div class="form-group">
