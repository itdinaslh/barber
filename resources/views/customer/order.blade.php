            ...
            <form id="formAddAndOrder" class="" action="{{ url('/customer/addorder') }}" method="post">
                <div class="modal-body">
                      ...
                      <div class="form-group">
                          ...
                          <input id="txtNama" type="text" name="Nama" maxlength="16" class="form-control uppercase" autocomplete="off" required />
                      </div>
                      <!-- <div class="form-group">
                          <label for="">No KTP</label>
                          <input type="number" name="IdNum" class="form-control" maxlength="16" autocomplete="off" />
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="Occupation" class="form-control uppercase" autocomplete="off" />
                      </div>
                      <div class="form-group">
                          <label for="">Kota</label>
                          <input type="text" name="City" class="form-control uppercase" autocomplete="off" />
                      </div>
                      <div class="form-group">
