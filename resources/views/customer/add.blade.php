<form action="{{ url('/customer/addpost') }}" method="post">
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            <input type="text" id="nama" class="form-control uppercase" name="Nama" required autofocus />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" maxlength="16" class="form-control" name="IdNum" />
        </div>
        <div class="form-group">
            <label for="Occupation">Pekerjaan</label>
            <input type="text" class="form-control uppercase" name="Occupation" />
        </div>
        <div class="form-group">
