...
<head>
    ...
    <title>My Brother Haircare | @yield('title')</title>
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <link rel="icon" href="{{ asset('/img/nm.ico') }}" type="image/x-icon" />
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="#" class="logo">
                ...
                <span class="logo-lg"><b>My Brother</b> Haircare</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; {{ date('Y') }} <a href="#">My Brother Haircare</a>.</strong>
        </footer>
    </div>
    <!-- ./wrapper -->
