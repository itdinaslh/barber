...
<head>
	...
	<link rel="stylesheet" href="/web/demos/conference/css/fonts.css" type="text/css" />
	<link rel="stylesheet" href="/web/css/colors.php?color=222" type="text/css" />
	<link rel="stylesheet" href="/web/demos/conference/conference.css" type="text/css" />
	<!-- / -->
...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
				...
				<div class="container">
					<div class="header-row justify-content-lg-between">
						...
						<div id="logo" class="mr-lg-0">
							<a href="#" data-scrollto="#slider" class="standard-logo" data-dark-logo="/web/demos/conference/images/logo-dark.png">
                                <img src="/web/demos/conference/images/logo.png" alt="Canvas Logo"></a>
							<a href="#" data-scrollto="#slider" class="retina-logo" data-dark-logo="/web/demos/conference/images/logo-dark@2x.png">
		...
		<!-- Hero/Slider
		============================================= -->
		<section id="slider" class="slider-element min-vh-60 min-vh-md-100 include-header" style="background: linear-gradient(rgba(0,0,0,.3), rgba(0,0,0,.8)), url('/web/demos/conference/images/hero-2.jpg') no-repeat center center / cover;">
						...
						<div class="row justify-content-between mt-5 col-mb-50">
							...
							<div class="col-lg-6 d-flex align-items-lg-end flex-column parallax text-left text-lg-right mb-5 mb-lg-0" data-0="transform: translateY(0px)" data-700="transform: translateY(-50px)">
								<div class="mt-auto">
									...
									<h4 class="font-weight-normal">795 Folsom Ave, Suite 600<br>San Francisco, CA 94107</h4>
			...
			<div class="content-wrap pt-0" style="overflow: visible;">
				...
				<div id="section-about" class="section page-section bg-transparent pt-0 clearfix">
					...
					<div class="container clearfix">
						...
						<div class="mb-5 dark">
							<span class="display-4 font-weight-bold gradient-underline font-primary">About The Conference</span>
						</div>
						...
						<div class="row justify-content-around dark">
							...
							<div class="col-md-5">
								<div class="about-img position-relative">
									<div class="my-3 my-lg-0"><div class="gradient-bg"><img src="/web/demos/conference/images/about/2.jpg" alt="About Image"></div></div>
									<div data-0="top: 160px" data-end="top: 120px"><div class="gradient-bg"><img src="/web/demos/conference/images/about/1.jpg" alt="About Image"></div></div>
								</div>
							</div>
						</div>
				...
				<div id="section-tickets" class="section page-section bg-transparent pt-0 clearfix">
					...
					<div class="position-relative">
								...
								<div class="col-lg-3 col-sm-6">
									<div class="pricing-box disabled text-center">
										...
										<div class="pricing-action px-5">
											<a href="#" class="button button-large button-gradient btn-block m-0">Buy Ticket</a>
										</div>
									</div>
								</div>
						...
						<div class="dotted-bg" style="background: url('/web/demos/conference/images/dotted-bg.svg') repeat center center / contain; min-height: 75%"></div>
					</div>
				...
				<div id="section-sponsors" class="section page-section bg-transparent pt-0 topmargin-lg clearfix">
					<div class="container">
						...
						<div class="mx-auto schedule-wrap center dark rounded shadow-lg" style="max-width: 1050px; background-color: #000">
							...
							<div class="d-flex flex-wrap align-items-center">
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/cnn.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/github.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/google.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/paypal.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/vimeo.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/slack.svg" alt="Brands"></a></div>
							</div>
							<div class="line"></div>
							<h4 class="font-body mb-5">Silver Sponsors</h4>
							<div class="d-flex flex-wrap align-items-center">
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/linkedin.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/nat-geo.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/jetblue.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/zillow.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/amazon.svg" alt="Brands"></a></div>
							</div>
							<div class="line"></div>
							<h4 class="font-body mb-5">Partners</h4>
							<div class="d-flex flex-wrap align-items-center">
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/ps.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/skype.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/jetblue.svg" alt="Brands"></a></div>
								<div class="flex-fill p-3"><a href="#"><img src="/web/demos/conference/images/sponcors/netflix.svg" alt="Brands"></a></div>
							</div>
							<div class="line"></div>
					...
					<div class="dotted-bg" style="background: url('/web/demos/conference/images/dotted-bg.svg') repeat center center / contain; min-height: 25%; top: 90%; right: 0; left: auto; width: 50%"></div>
								...
								<div class="row justify-content-between dark">
									<div class="col-md-4 mb-4">
										...
										<div class="masonry-thumbs grid-container grid-3" data-lightbox="gallery">
											<a class="grid-item" href="/web/demos/conference/images/venue/full/1.jpg" data-lightbox="gallery-item"><img src="/web/demos/conference/images/venue/1.jpg" alt="Gallery Thumb 1"></a>
											<a class="grid-item" href="/web/demos/conference/images/venue/full/2.jpg" data-lightbox="gallery-item"><img src="/web/demos/conference/images/venue/2.jpg" alt="Gallery Thumb 2"></a>
											<a class="grid-item" href="/web/demos/conference/images/venue/full/3.jpg" data-lightbox="gallery-item"><img src="/web/demos/conference/images/venue/3.jpg" alt="Gallery Thumb 3"></a>
											<a class="grid-item" href="/web/demos/conference/images/venue/full/4.jpg" data-lightbox="gallery-item"><img src="/web/demos/conference/images/venue/4.jpg" alt="Gallery Thumb 4"></a>
											<a class="grid-item" href="/web/demos/conference/images/venue/full/5.jpg" data-lightbox="gallery-item"><img src="/web/demos/conference/images/venue/5.jpg" alt="Gallery Thumb 5"></a>
											<a class="grid-item" href="/web/demos/conference/images/venue/full/6.jpg" data-lightbox="gallery-item"><img src="/web/demos/conference/images/venue/6.jpg" alt="Gallery Thumb 6"></a>
											<a class="grid-item" href="/web/demos/conference/images/venue/full/7.jpg" data-lightbox="gallery-item"><img src="/web/demos/conference/images/venue/7.jpg" alt="Gallery Thumb 7"></a>
											<a class="grid-item" href="/web/demos/conference/images/venue/full/8.jpg" data-lightbox="gallery-item"><img src="/web/demos/conference/images/venue/8.jpg" alt="Gallery Thumb 9"></a>
											<a class="grid-item" href="/web/demos/conference/images/venue/full/9.jpg" data-lightbox="gallery-item"><img src="/web/demos/conference/images/venue/9.jpg" alt="Gallery Thumb 10"></a>
										</div>
									</div>
				...
				<div class="section bg-transparent m-0 clearfix">
					...
					<div class="container">
						<div class="mx-auto dark center" style="max-width: 850px">
							<span class="display-4 font-weight-bold gradient-underline">Upcoming Related Events</span>
						...
						<div class="row align-items-stretch mt-3 clearfix">
							<div class="col-md-4 mb-3">
								<a href="#" class="card dark" style="background-color: #FB6567">
									<div class="card-body">
										<h4 class="mb-4 font-body font-weight-normal h5">Opening Remarks And Keynote</h4>
							...
							<div class="col-md-4 mb-3">
								<a href="#" class="card dark" style="background-color: #F3317A">
									<div class="card-body">
										<h4 class="mb-4 font-body font-weight-normal h5">Hiring The Right Way in Ecosystem</h4>
							...
							<div class="col-md-4 mb-3">
								<a href="#" class="card dark" style="background-color: #EC008B">
									<div class="card-body">
										<h4 class="mb-4 font-body font-weight-normal h5">Why Should I Choose Support</h4>
							...
							<div class="widget clearfix">
								<div class="row clearfix">
									<div class="col-lg-8 bottommargin-sm clearfix" style="color:#888;">
										<img src="/web/demos/app-landing/images/logo-dark@2x.png" alt="Canvas Logo" style="display: block;" height="100">
							...
							<div class="row clearfix">
								...
								<div class="col-lg-6 bottommargin-sm">
									<div id="twitter" class="widget widget-twitter-feed pt-3">
										...
										<a href="#" class="button button-gradient text-white float-right">Follow Us on Twitter</a>
