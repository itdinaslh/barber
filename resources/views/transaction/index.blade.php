...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-body">
                <table id="trx" class="table table-bordered table-hover table-responsive dataTable">
                    <thead>
                        <tr>
                            <th>Trx ID</th>
                            <th>Customer</th>
    ...
    <div id="detailDiv" class="col-xs-12" style="display:none;">
            ...
            <div class="box-body">
               ...
               <div class="col-md-6 col-xs-12">
                  <form id="formProduct" class="form-inline" action="/transaction/addtransbbproduct" method="post">
                      ...
                      <button type="submit" class="btn btn-success" id="btnAddProduct" style="width:100px;">Add</button>
                  </form>
               </div>

                <div id="transdetail" style="margin-top:15px">
                  <table class="table table-hover table-bordered table-responsive table-stripped" id="trxDetail">
                      <thead>
                          <tr>
                              <th>TrxID</th>
                              <th>Service</th>
                ...
                <div id="transproduct" style="margin-top:15px">
                  <table class="table table-hover table-bordered table-responsive table-stripped" id="trxProduct">
                      <thead>
                          <tr>
                              <th>TrxID</th>
                              <th>Produk</th>
        ...
        <div class="col-xs-12">
          <div class="pull-right">
              <button type="button" id="btnCheckout" class="btn btn-info showMe" data-href="{{ url('/transaction/getcheckout-')}}">Checkout</a>
          </div>
        </div>
    </div>
</div>
...
<script src="{{ asset('/js/pages/transaction/transdetail.js') }}"></script>
