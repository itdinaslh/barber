...
<div class="row">
  <div class="col-xs-12 myCenter" style="margin-top:4mm;">
    <div style="padding-left:22mm;">
        <img src="{{ asset('/img/logo-small.png') }}" class="img img-responsive logo" alt="" />
        <span style="float:left;margin-left:2mm;font-size:18px;font-weight:bold;">My Brother Haircare</span>
    </div>
  </div>
</div>
<div class="row invoice-info">
    <div class="col-xs-12">
      <div style="padding-bottom:1mm;text-align:center;font-size:9pt;border-bottom:1px solid black;">
          ...
          <table style="width:100%;margin-top:1mm;">
              <tbody>
                  ...
                  @if($trans->Discount != 0)
                    <tr>
                        <td></td>
                        <td colspan="2" style="text-align:right;padding-right:2mm;">({{ $trans->DiscountID }})</td>
                        <td>Discount</td>
                  ...
                  @if($trans->VoucherVal != 0)
                    <tr>
                        <td></td>
                        <td colspan="2" style="text-align:right;padding-right:2mm;">({{ $trans->VoucherID }})</td>
                        <td>Voucher</td>
