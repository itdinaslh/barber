...
<!--Modal Window-->
  ...
  <div class="row">
              ...
              <div class="box-body">
                    ...
                    <form class="form-inline">
                        <div class="form-group">
                            ...
                            <select id="trxdropdown" class="form-control" name="">
                                @foreach($data as $v)
                                    <option value="{{ $v->id }}" data-member="{{ $v->MemberID }}">{{ $v->MemberID }} - {{ $v->Nama }}</option>
                                @endforeach
                            </select>
                        </div>
                    </form>
                  ...
                  <div class="col-md-6 col-xs-12">
                        <div class="pull-right">
                            <button type="button" class="btn btn-warning showMe" data-href="{{ url('/customer/getorder') }}" name="button">New Transaction</button>
                        </div>
                  </div>
              </div>
          </div>
      ...
      <div id="detailDiv" class="col-xs-12" style="display:none;">
          ...
          <div class="col-xs-12">
            <div class="pull-right">
                <button id="btnCheckOut" type="button" name="btnCheckOut" class="btn btn-info showMe" data-href="/transaction/getcheckout-">Bayar</button>
            </div>
          </div>
      </div>
